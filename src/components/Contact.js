          ...
          <div className="col-md-12">
            <div className="section-title">
              ...
              <p className="text-uppercase small">
                Expert Shopify Developer | Custom Themes & Stores That Convert 🚀
              </p>
          ...
          <div className="col-lg-4 m-15px-tb">
            ...
            <div className="contact-info media box-shadow">
              ...
              <div className="media-body">
                ...
                <p>
                  <a href="tel:+923027667774" className="text-dark-color">
                    Office: +92 302-7667774
                  </a>
                </p>
            ...
            <div className="contact-info media box-shadow">
              ...
              <div className="media-body">
                ...
                <p>
                  <a href="mailto:sheikhmuhaiman@gmail.com" className="text-dark-color">
                    sheikhmuhaiman@gmail.com
                  </a>
                </p>
